...
// Передача запроса в JSP.
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher dispatcher_for_manager = request.getRequestDispatcher("/ManagePerson.jsp");
        RequestDispatcher dispatcher_for_list = request.getRequestDispatcher("/List.jsp");
        RequestDispatcher dispatcher_for_managerNumber = request.getRequestDispatcher("/List.jsp");
        ...
        String editNumber_go = request.getParameter("edNumber_go");
...
// Создание записи на основе данных из формы.
            ...
            String error_message = this.validateNumberName(request.getParameter("phone"), add_number_person);
...
// Передача запроса в JSP.
        ...
        if (editNumber_go != null) {
            ...
            String error_message = this.validateNumberName(request.getParameter("phone"), updatableNumber_person);
            String numberID = request.getParameter("numberID");
    ...
    private String validateNumberName(String phones, Person person) {
        String error_message = "";
        if (!person.validateNumber(phones,person)) {
            error_message += "Телефон должен содержать от 3 до 50 символов,может содержать цифры и символы +#-<br />";
        }
        return error_message;
    }
