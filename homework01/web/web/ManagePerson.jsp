    ...
    <table align="center" border="1" width="70%">
        ...
        <tr>
            ...
            <td>
                ...
                %>
                <a href="<%=request.getContextPath()%>/?action=editNumber&id=<%=person.getId()%>&numberID=<%=phone.getKey()%>">Редактировать</a>
                <a href="<%=request.getContextPath()%>/?action=deleteNumber&id=<%=person.getId()%>&numberID=<%=phone.getKey()%>">Удалить </a>
                <br>
                <%
                    }
                %>
                <a href="<%=request.getContextPath()%>/?action=addNumber&id=<%=person.getId()%>">Добавить</a>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2" align="center">
                <a href="<%=request.getContextPath()%>/?action=toList&id=<%=person.getId()%>">Вернуться к списку</a>
            </td>
        </tr>
    </table>
</form>
