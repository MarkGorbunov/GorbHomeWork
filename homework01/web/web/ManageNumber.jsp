...
<%
    ...
    if (request.getAttribute("person") != null)
    {
        ...
        numberID = (String)request.getAttribute("numberID");
    }
...
<form action="<%=request.getContextPath()%>/" method="post">
    ...
    <input type="hidden" name="numberID" value="<%=(String) request.getAttribute("numberID")%>"/>
    <table align="center" border="1" width="70%">
        ...
        <tr>
            <td
                    colspan="2" align="center">Информация о телефоне владельца:
                <%=person.getSurname()%>
                <%=person.getName()%>
        ...
        <tr>
            <td>Телефоны:</td>
            <td>
                <input name="phone" value="<%=person.getPhones().get(numberID)%>">
                </input>
            </td>
        </tr>
        <tr>
